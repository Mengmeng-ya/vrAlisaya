...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs+='bottom : 130px;';
		hs+='height : 132px;';
		hs+='left : calc(50% - ((512px + 0px) / 2) - 10px);';
		...
		me._container_1.appendChild(me._button_21);
		...
		me._container_1.appendChild(me._button_22);
		...
		el.ggType='rectangle';
		hs ='';
		hs+='background : #a1adc7;';
		hs+='border : 1px solid #b1b1b1;';
		hs+='bottom : -5px;';
		hs+='height : 129px;';
		hs+='left : -1px;';
		hs+='opacity : 0.59999;';
		...
		hs ='';
		hs+='height : 89px;';
		hs+='left : calc(50% - ((359px + 0px) / 2) - 25px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((89px + 0px) / 2) - 2px);';
		hs+='visibility : inherit;';
		hs+='width : 359px;';
		hs+='pointer-events:none;';
		el.setAttribute('style',hs);
		...
		me._rectangle_1.appendChild(me._container_2);
		...
		el=me._container_1_2=document.createElement('div');
		el.ggId="Container 1_2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		el.ggType='container';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._container_1_2.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._container_1_2.ggUpdatePosition=function (useTransition) {
		}
		el=me.__10=document.createElement('div');
		els=me.__10__img=document.createElement('img');
		els.className='ggskin ggskin__10';
		hs=basePath + 'images/_10.jpg';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		...
		me.__10.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				me.__10.style.transition='none';
			} else {
				me.__10.style.transition='all 1000ms ease-out 0ms';
			}
			me.__10.ggParameter.rx=300;me.__10.ggParameter.ry=0;
			me.__10.style.transform=parameterToTransform(me.__10.ggParameter);
			me.elementMouseOver['_10']=true;
		}
		me.__10.onmouseleave=function (e) {
			me.__10.style.transition='none';
			me.__10.ggParameter.rx=0;me.__10.ggParameter.ry=0;
			me.__10.style.transform=parameterToTransform(me.__10.ggParameter);
		...
		me.__10.appendChild(me._marker_2);
		...
		me.__10.appendChild(me._marker_1);
		me._container_1_2.appendChild(me.__10);
		me.divSkin.appendChild(me._container_1_2);
		...
		me._container_3.appendChild(me.__9);
		...
		hs=basePath + 'images/button_18.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		...
		hs+='cursor : pointer;';
		hs+='height : 167px;';
		hs+='left : calc(50% - ((167px + 0px) / 2) + 0px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((167px + 0px) / 2) + 0px);';
		hs+='visibility : inherit;';
		hs+='width : 167px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='position : absolute;';
		hs+='top : calc(50% - ((76px + 0px) / 2) - 33px);';
		hs+='visibility : inherit;';
		hs+='width : 10px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._button_18.appendChild(me.__7);
		...
		me._container_5.appendChild(me.__6);
		...
		hs+='left : calc(50% - ((10px + 0px) / 2) + 3px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((55px + 0px) / 2) - 25px);';
		hs+='visibility : inherit;';
		hs+='width : 10px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._button_18.appendChild(me.__5);
		...
		me.elementMouseOver['_10']=false;
		var clonedNormalElement = new SkinElement_image_3_Class(this,me._marker_2);
		me._marker_2__normal = clonedNormalElement._image_3;
		...
		var clonedActiveElement = new SkinElement_image_2_1_Class(this,me._marker_2);
		me._marker_2__active = clonedActiveElement._image_2_1;
		...
		var clonedNormalElement = new SkinElement_image_3_Class(this,me._marker_1);
		me._marker_1__normal = clonedNormalElement._image_3;
		...
		var clonedActiveElement = new SkinElement_image_2_1_Class(this,me._marker_1);
		me._marker_1__active = clonedActiveElement._image_2_1;
		...
		player.addListener('activehotspotchanged', function(event) {
			if (hotspotTemplates.hasOwnProperty('导览节点')) {
				for(var i = 0; i < hotspotTemplates['导览节点'].length; i++) {
					hotspotTemplates['导览节点'][i].ggEvent_activehotspotchanged();
				}
			}
			if (hotspotTemplates.hasOwnProperty('网址')) {
				for(var i = 0; i < hotspotTemplates['网址'].length; i++) {
					hotspotTemplates['网址'][i].ggEvent_activehotspotchanged();
				}
			}
			if (hotspotTemplates.hasOwnProperty('图像')) {
				for(var i = 0; i < hotspotTemplates['图像'].length; i++) {
					hotspotTemplates['图像'][i].ggEvent_activehotspotchanged();
				}
			}
		});
		...
		player.addListener('changenode', function(event) {
			if (hotspotTemplates.hasOwnProperty('导览节点')) {
				for(var i = 0; i < hotspotTemplates['导览节点'].length; i++) {
					hotspotTemplates['导览节点'][i].ggEvent_changenode();
				}
			}
			if (hotspotTemplates.hasOwnProperty('网址')) {
				for(var i = 0; i < hotspotTemplates['网址'].length; i++) {
					hotspotTemplates['网址'][i].ggEvent_changenode();
				}
			}
			if (hotspotTemplates.hasOwnProperty('图像')) {
				for(var i = 0; i < hotspotTemplates['图像'].length; i++) {
					hotspotTemplates['图像'][i].ggEvent_changenode();
				}
			}
			me._timer_1.logicBlock_visible();
			me._timer_2.logicBlock_visible();
		...
		player.addListener('configloaded', function(event) {
			if (hotspotTemplates.hasOwnProperty('导览节点')) {
				for(var i = 0; i < hotspotTemplates['导览节点'].length; i++) {
					hotspotTemplates['导览节点'][i].ggEvent_configloaded();
				}
			}
			if (hotspotTemplates.hasOwnProperty('网址')) {
				for(var i = 0; i < hotspotTemplates['网址'].length; i++) {
					hotspotTemplates['网址'][i].ggEvent_configloaded();
				}
			}
			if (hotspotTemplates.hasOwnProperty('图像')) {
				for(var i = 0; i < hotspotTemplates['图像'].length; i++) {
					hotspotTemplates['图像'][i].ggEvent_configloaded();
				}
			}
			me._loading.logicBlock_visible();
		});
		...
		player.addListener('varchanged_Hou', function(event) {
			...
			me.__5.ggParameter.a=player.getVariableValue("Hou")*10.0;
		...
		player.addListener('varchanged_Min', function(event) {
			...
			me.__7.ggParameter.a=player.getVariableValue("Min")*6.0;
	...
	function SkinHotspotClass__(parentScope,hotspot) {
		...
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			'';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
	...
	function SkinHotspotClass__1(parentScope,hotspot) {
		...
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			'bMDC6VSqXSVVdX/8zlcme6urpgs9lw/PhxJCUlrRiKz+fjzJkz6O3tXShvZ6qrq39eDg5YZRPdZDKpsrOz1fn5+YLJyUn09/fD6XTC6XRidHQUbrcbs7OzEIvFIAgCcrkcubm52LFjBzZu3Ai73f59muiR0uv1QolEciI9PV2WkZGRKpVKY76GGBoa8r979+6Tx+NZ82uI3wAYvBl+l1zHqwAAAABJRU5ErkJggg==';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
	...
	function SkinHotspotClass__3(parentScope,hotspot) {
		...
		hs='data:image/png;base64,'+
			'';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
	...
	function SkinElement_image_2_1_Class(parentScope,ggParent) {
		var me=this;
		var flag=false;
		me.parentScope=parentScope;
		me.ggParent=ggParent;
